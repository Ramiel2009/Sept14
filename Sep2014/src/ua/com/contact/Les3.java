...
/*		double x;
		...
		System.out.println(Math.sqrt((16))); //êâàäðàòíûé êîðåíü
		System.out.println(Math.pow(2, 1/2)); // 2 â êóáå
		System.out.println(Math.random()); // ðàáîòàåò îò 0 äî 1 (>=0 && <1)
		System.out.println((int)(Math.random()*10));
		System.out.println(Math.random()+3); // ðàíäîì îò 3 äî 4
		System.out.println(Math.random()*5); // ðàíäîì îò 0 äî 5
		System.out.println(Math.random()*5+3); // ðàíäîì îò 5 äî 8
*/
		
		/*Scanner in = new Scanner (System.in); //ââîä äàííûõ
		int n;
...
/****************************************/
	...
	*/	
	...
	/*	int n = ((int) (Math.random()*100));
		...
		// int []a = new int [5]; //îáüÿâëåíèå ìàñèâà
		// int b []; //same as ^
		// int b [] = new int [5]; //ìàñèâ èç 5 îáüåêòîâ, 5 çíà÷åíèé ñî çíà÷åíèåì ïî óìîë÷àíèþ - 0
		// System.out.println(b.length); //b.length - âûâåñòè äëèíó ìàñèâà
		/* int b [] = {3, 2, 5};
...
//		int a [][] = new int [3][3];
	//	System.out.println(Arrays.deepToString(a));
		...
		//ðàíäîìíûìè ÷èñëàìè çàïîëíèòü ìàññèâ èç 10 ÷èñåë
